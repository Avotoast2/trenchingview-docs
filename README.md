...
1. **Update the page when the feature ships.** A user-facing change on the site (the verdict card, the Project panel, the team rule, plans and credits, Videos, the radar, AskAura) gets its page edited in the same session as the code.
